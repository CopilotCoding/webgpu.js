// Byte size of each GPUVertexFormat, used to compute tightly-packed strides.
export const VERTEX_FORMAT_SIZES = {
  uint8x2: 2, uint8x4: 4,
  sint8x2: 2, sint8x4: 4,
  unorm8x2: 2, unorm8x4: 4,
...
// Byte size per index for GPUIndexFormat.
export const INDEX_FORMAT_SIZES = {
  uint16: 2,
  uint32: 4,
};
